...
pub type I32 = ::std::os::raw::c_long;
pub type U32 = ::std::os::raw::c_ulong;
pub type line_t = U32;
#[repr(C)]
...
#[repr(C)]
#[derive(Copy, Clone)]pub union _xmgu { pub xmg_magic : * mut MAGIC , pub xmg_hash_index : isize , _bindgen_union_align : u64 , }#[test]
...
#[repr(C)]
#[derive(Copy, Clone)]; 15usize ] , }#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub struct regmatch_slab {
    pub states: [regmatch_state; 29usize],
...
pub type perl_drand48_t = ::std::os::raw::c_ulonglong;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct gp {
    pub gp_sv: *mut SV,
...
fn bindgen_test_layout_unop_aux() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<unop_aux>())).op_sibling as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(unop_aux),
...
impl ::std::fmt::Debug for pmop {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(
            f,
            "pmop {{ op_next: {:?}, op_sibling: {:?}, op_ppaddr: {:?}, op_targ: {:?}, op_type : {:?}, op_opt : {:?}, op_slabbed : {:?}, op_savefree : {:?}, op_static : {:?}, op_folded : {:?}, op_moresib : {:?}, op_typechecked : {:?}, op_flags: {:?}, op_private: {:?}, op_rettype: {:?}, op_first: {:?}, op_last: {:?}, op_pmoffset: {:?}, op_pmflags: {:?}, op_pmreplrootu: {:?}, op_pmstashstartu: {:?}, op_code_list: {:?} }}",
            self.op_next,
            self.op_sibling,
            self.op_ppaddr,
            self.op_targ,
...
#[repr(C)]
#[derive(Copy, Clone)]; 14usize ] , }#[test]
