...
impl op {
    ...
    #[inline]
    pub fn new_bitfield_1(op_type: ::std::os::raw::c_uint, op_opt: ::std::os::raw::c_uint, op_slabbed: ::std::os::raw::c_uint, op_savefree: ::std::os::raw::c_uint, op_static: ::std::os::raw::c_uint, op_folded: ::std::os::raw::c_uint, op_spare: ::std::os::raw::c_uint) -> __BindgenBitfieldUnit<[u8; 2usize], u16> {
        let mut __bindgen_bitfield_unit: __BindgenBitfieldUnit<[u8; 2usize], u16> = Default::default();
...
impl ::std::fmt::Debug for pmop {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(
            f,
            "pmop {{ op_next: {:?}, op_sibling: {:?}, op_ppaddr: {:?}, op_targ: {:?}, op_type : {:?}, op_opt : {:?}, op_slabbed : {:?}, op_savefree : {:?}, op_static : {:?}, op_folded : {:?}, op_spare : {:?}, op_flags: {:?}, op_private: {:?}, op_first: {:?}, op_last: {:?}, op_pmoffset: {:?}, op_pmflags: {:?}, op_pmreplrootu: {:?}, op_pmstashstartu: {:?}, op_code_list: {:?} }}",
            self.op_next,
            self.op_sibling,
            self.op_ppaddr,
            self.op_targ,
...
impl yy_parser {
    ...
    #[inline]
    pub fn new_bitfield_1(in_pod: ::std::os::raw::c_uint, filtered: ::std::os::raw::c_uint, saw_infix_sigil: ::std::os::raw::c_uint) -> __BindgenBitfieldUnit<[u8; 1usize], u8> {
