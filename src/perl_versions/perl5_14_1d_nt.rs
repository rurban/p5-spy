...
pub type line_t = U32;
#[repr(C)]
#[derive(Copy, Clone)]pub union any { pub any_ptr : * mut :: std :: os :: raw :: c_void , pub any_i32 : I32 , pub any_iv : IV , pub any_uv : UV , pub any_long : :: std :: os :: raw :: c_long , pub any_bool : :: std :: os :: raw :: c_char , pub any_dptr : :: std :: option :: Option < unsafe extern "C" fn ( arg1 : * mut :: std :: os :: raw :: c_void ) > , pub any_dxptr : :: std :: option :: Option < unsafe extern "C" fn ( arg1 : * mut :: std :: os :: raw :: c_void ) > , _bindgen_union_align : u64 , }#[test]
...
#[repr(C)]
#[derive(Copy, Clone)]pub union xpvcv__bindgen_ty_2 { pub xcv_root : * mut OP , pub xcv_xsub : :: std :: option :: Option < unsafe extern "C" fn ( arg1 : * mut CV ) > , _bindgen_union_align : u64 , }#[test]
