...
#[repr(C)]
#[derive(Copy, Clone)]; 11usize ] , }#[test]
...
fn bindgen_test_layout_interpreter() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<interpreter>())).Isawalias as *const _ as usize },
        136usize,
        concat!(
            "Offset of field: ",
            stringify!(interpreter),
