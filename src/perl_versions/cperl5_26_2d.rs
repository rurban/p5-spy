...
#[repr(C)]
#[derive(Copy, Clone)]pub union gv__bindgen_ty_1 { pub svu_pv : * mut :: std :: os :: raw :: c_char , pub svu_iv : IV , pub svu_uv : UV , pub svu_nv : NV , pub svu_rv : * mut SV , pub svu_rx : * mut regexp , pub svu_array : * mut * mut SV , pub svu_hash : * mut * mut HE , pub svu_gp : * mut GP , pub svu_fp : * mut PerlIO , _bindgen_union_align : u64 , }#[test]
...
#[repr(C)]
#[derive(Copy, Clone)]pub union cv__bindgen_ty_1 { pub svu_pv : * mut :: std :: os :: raw :: c_char , pub svu_iv : IV , pub svu_uv : UV , pub svu_nv : NV , pub svu_rv : * mut SV , pub svu_rx : * mut regexp , pub svu_array : * mut * mut SV , pub svu_hash : * mut * mut HE , pub svu_gp : * mut GP , pub svu_fp : * mut PerlIO , _bindgen_union_align : u64 , }#[test]
...
#[repr(C)]
#[derive(Copy, Clone)]pub union av__bindgen_ty_1 { pub svu_pv : * mut :: std :: os :: raw :: c_char , pub svu_iv : IV , pub svu_uv : UV , pub svu_nv : NV , pub svu_rv : * mut SV , pub svu_rx : * mut regexp , pub svu_array : * mut * mut SV , pub svu_hash : * mut * mut HE , pub svu_gp : * mut GP , pub svu_fp : * mut PerlIO , _bindgen_union_align : u64 , }#[test]
...
#[repr(C)]
#[derive(Copy, Clone)]pub union hv__bindgen_ty_1 { pub svu_pv : * mut :: std :: os :: raw :: c_char , pub svu_iv : IV , pub svu_uv : UV , pub svu_nv : NV , pub svu_rv : * mut SV , pub svu_rx : * mut regexp , pub svu_array : * mut * mut SV , pub svu_hash : * mut * mut HE , pub svu_gp : * mut GP , pub svu_fp : * mut PerlIO , _bindgen_union_align : u64 , }#[test]
...
#[repr(C)]
#[derive(Copy, Clone)]pub union io__bindgen_ty_1 { pub svu_pv : * mut :: std :: os :: raw :: c_char , pub svu_iv : IV , pub svu_uv : UV , pub svu_nv : NV , pub svu_rv : * mut SV , pub svu_rx : * mut regexp , pub svu_array : * mut * mut SV , pub svu_hash : * mut * mut HE , pub svu_gp : * mut GP , pub svu_fp : * mut PerlIO , _bindgen_union_align : u64 , }#[test]
...
#[repr(C)]
#[derive(Copy, Clone)]pub union p5rx__bindgen_ty_1 { pub svu_pv : * mut :: std :: os :: raw :: c_char , pub svu_iv : IV , pub svu_uv : UV , pub svu_nv : NV , pub svu_rv : * mut SV , pub svu_rx : * mut regexp , pub svu_array : * mut * mut SV , pub svu_hash : * mut * mut HE , pub svu_gp : * mut GP , pub svu_fp : * mut PerlIO , _bindgen_union_align : u64 , }#[test]
...
#[repr(C)]
#[derive(Copy, Clone)]pub union UNOP_AUX_item { pub pad_offset : PADOFFSET , pub sv : * mut SV , pub iv : IV , pub uv : UV , _bindgen_union_align : u64 , }#[test]
...
impl ::std::fmt::Debug for jmpenv {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(
            f,
            "jmpenv {{ je_prev: {:?}, je_buf: [{}], je_ret: {:?}, je_mustcatch: {:?}, je_old_delaymagic: {:?} }}",
            self.je_prev,
            self.je_buf
                .iter()
                .enumerate()
...
impl ::std::fmt::Debug for yy_parser {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(
            f,
            "yy_parser {{ yylen: {:?}, yychar: {:?}, yylval: {:?}, stack: {:?}, stack_max1: {:?}, ps: {:?}, old_parser: {:?}, yyerrstatus: {:?}, tokenbuf: [{}], lex_brackets: {:?}, lex_casemods: {:?}, lex_brackstack: {:?}, lex_casestack: {:?}, lex_defer: {:?}, lex_dojoin: {:?}, expect: {:?}, preambled: {:?}, lex_formbrack: {:?}, lex_inpat: {:?}, lex_op: {:?}, lex_repl: {:?}, lex_inwhat: {:?}, last_lop_op: {:?}, lex_starts: {:?}, lex_stuff: {:?}, multi_start: {:?}, multi_end: {:?}, multi_open: {:?}, multi_close: {:?}, lex_re_reparsing: {:?}, lex_super_state: {:?}, lex_sub_inwhat: {:?}, lex_allbrackets: {:?}, lex_sub_op: {:?}, lex_sub_repl: {:?}, lex_shared: {:?}, linestr: {:?}, bufptr: {:?}, oldbufptr: {:?}, oldoldbufptr: {:?}, bufend: {:?}, linestart: {:?}, last_uni: {:?}, last_lop: {:?}, copline: {:?}, in_my: {:?}, lex_state: {:?}, error_count: {:?}, in_my_stash: {:?}, rsfp: {:?}, rsfp_filters: {:?}, nextval: {:?}, nexttype: {:?}, saved_curcop: {:?}, herelines: {:?}, preambling: {:?}, form_lex_state: {:?}, nexttoke: {:?}, lex_fakeeof: {:?}, lex_flags: {:?}, recheck_utf8_validity : {:?}, in_pod : {:?}, filtered : {:?}, saw_infix_sigil : {:?}, parsed_sub : {:?} }}",
            self.yylen,
            self.yychar,
            self.yylval,
            self.stack,
...
impl yy_parser {
    ...
    #[inline]
    pub fn new_bitfield_1(recheck_utf8_validity: ::std::os::raw::c_uint, in_pod: ::std::os::raw::c_uint, filtered: ::std::os::raw::c_uint, saw_infix_sigil: ::std::os::raw::c_uint, parsed_sub: ::std::os::raw::c_uint) -> __BindgenBitfieldUnit<[u8; 1usize], u8> {
...
fn bindgen_test_layout_interpreter() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<interpreter>())).ILB_invlist as *const _ as usize },
        2640usize,
        concat!(
            "Offset of field: ",
            stringify!(interpreter),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<interpreter>())).IAssigned_invlist as *const _ as usize },
        2664usize,
        concat!(
            "Offset of field: ",
            stringify!(interpreter),
