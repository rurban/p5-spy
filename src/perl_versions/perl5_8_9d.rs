...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct xiv_allocated {
    pub xiv_iv: IV,
}
#[test]
fn bindgen_test_layout_xiv_allocated() {
    assert_eq!(
        ::std::mem::size_of::<xiv_allocated>(),
        8usize,
        concat!("Size of: ", stringify!(xiv_allocated))
    );
    assert_eq!(
        ::std::mem::align_of::<xiv_allocated>(),
        8usize,
        concat!("Alignment of ", stringify!(xiv_allocated))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<xiv_allocated>())).xiv_iv as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(xiv_allocated),
            "::",
            stringify!(xiv_iv)
        )
    );
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct xnv_allocated {
    pub xnv_nv: NV,
}
#[test]
fn bindgen_test_layout_xnv_allocated() {
    assert_eq!(
        ::std::mem::size_of::<xnv_allocated>(),
        8usize,
        concat!("Size of: ", stringify!(xnv_allocated))
    );
    assert_eq!(
        ::std::mem::align_of::<xnv_allocated>(),
        8usize,
        concat!("Alignment of ", stringify!(xnv_allocated))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<xnv_allocated>())).xnv_nv as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(xnv_allocated),
            "::",
            stringify!(xnv_nv)
        )
    );
...
pub type xpvav_allocated = xpvav;
pub type HE = he;
pub type HEK = hek;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub type xpvhv_allocated = xpvhv;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct mgvtbl {
...
pub type regdupe_t = ::std::option::Option<
    unsafe extern "C" fn(my_perl: *mut PerlInterpreter,
                         r: *const regexp,
                         param: *mut CLONE_PARAMS) -> *mut regexp,
>;
...
pub struct interpreter {
    ...
    pub Ixiv_arenaroot: *mut xiv_allocated,
    pub Ixiv_root: *mut xiv_allocated,
    pub Ixnv_root: *mut xnv_allocated,
    pub Ixrv_root: *mut XRV,
    pub Ixpv_root: *mut xpv_allocated,
    pub Ixpviv_root: *mut XPVIV,
    pub Ixpvnv_root: *mut XPVNV,
    pub Ixpvcv_root: *mut XPVCV,
    pub Ixpvav_root: *mut xpvav_allocated,
    pub Ixpvhv_root: *mut xpvhv_allocated,
    ...
    pub Ixnv_arenaroot: *mut xnv_allocated,
    pub Ixrv_arenaroot: *mut XPV,
    pub Ixpv_arenaroot: *mut xpv_allocated,
    pub Ixpviv_arenaroot: *mut XPVIV,
    pub Ixpvnv_arenaroot: *mut XPVNV,
    pub Ixpvcv_arenaroot: *mut XPVCV,
    pub Ixpvav_arenaroot: *mut xpvav_allocated,
    pub Ixpvhv_arenaroot: *mut xpvhv_allocated,
...
fn bindgen_test_layout_interpreter() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<interpreter>())).Iregdupe as *const _ as usize },
        4272usize,
        concat!(
            "Offset of field: ",
            stringify!(interpreter),
